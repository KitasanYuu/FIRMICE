...
namespace Avatar
{
    public class DistanceDither : MonoBehaviour
    {
        ...
        private AllinOne allinoneTarget;
        private AllinOne allinoneClone;
        ...
        {
            allinoneTarget = MainTarget.GetComponent<AllinOne>();
            allinoneClone = CloneTarget.GetComponent<AllinOne>();
