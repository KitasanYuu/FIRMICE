...
{
    public static void BarPositionAdjust(Canvas canvas, Camera mainCamera, Transform floatAnchor, RectTransform targetTransfrom, Transform PlayerAnchor = null, float baseOffsetY = 0, float smoothSpeed = 50f)
    {
        // 计算摄像机到NPC的距离
        ...
        {
            screenPos = mainCamera.WorldToScreenPoint(PlayerAnchor.position + new Vector3(0, baseOffsetY, 0));
        }
        else
        {
